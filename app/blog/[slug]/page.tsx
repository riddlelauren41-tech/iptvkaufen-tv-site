  ...
  return (
    <article className="section">
      ...
      <div className="container-px max-w-3xl mx-auto">
        <p className="text-sm muted mb-3">{fmt(post.date)} &middot; {post.readTime} Min. Lesezeit &middot; {post.categoryLabel}</p>
        ...
        <div className="card p-8 mt-12 text-center dark-block">
          ...
          <p className="muted mb-5">Bestelle dein IPTV-Abo und erhalte sofortige Aktivierung über WhatsApp.</p>
